...
{
    public class RecursiveFibonachiNumbersMemoryEffective : ITask
    {
        public RecursiveFibonachiNumbersMemoryEffective( IChapter chapter)
        {
            Chapter = chapter;
        }
        ...
        public string Name => "Эффективные числа ФИбоначчи";

        public string Description => "Рассчитать n индекс в последовательности Фибоначчи";
